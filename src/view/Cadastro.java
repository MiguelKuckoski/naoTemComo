	...
	public Cadastro() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
								.addComponent(getTextFieldSenha())
								.addComponent(getTextFieldCnh(), GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE))
						.addGap(126))
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(getLblSenha())
						.addComponent(getTextFieldSenha(), GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE))
				.addGap(7)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
